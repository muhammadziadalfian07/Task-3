...
class CalculateVolume extends StatefulWidget {
  @override
  _CalculateVolumeState createState() => _CalculateVolumeState();
}
                      ...
                      Container(
                        ...
                        child: RaisedButton(
                          ...
                          onPressed: () {
                            ...
                            } else if (!(tinggiController.text.trim() != "")) {
                              Flushbar(
                                duration: Duration(seconds: 2),
                                flushbarPosition: FlushbarPosition.TOP,
                                backgroundColor: Color(0xFFFF5C83),
                                message: "Tinggi must not be empty",
                              ).show(context);
                            } else {
                              var panjang = int.parse(panjangController.text);
                              var lebar = int.parse(lebarController.text);
                              var tinggi = int.parse(tinggiController.text);
                              int hasil = hitungVolume(panjang, lebar, tinggi);
                              setState(() {
                                screenText = hasil;
                              });
                            }
